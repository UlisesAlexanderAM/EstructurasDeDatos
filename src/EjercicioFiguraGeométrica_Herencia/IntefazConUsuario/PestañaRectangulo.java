...
public class PestañaRectangulo {
	...
	private JTextPane instruccionesTextPane;

	public PestañaRectangulo() {
//		$$$setupUI$$$();
		instruccionesTextPane.setText(String.format("Aquí podras calcular el area y perimetro de un rectangulo.\nProporcionando la base y la altura.\nPara mostrar los resultados presionar el boton \"Calcular\""));
		instruccionesTextPane.setSize(250, 50);
		descripcionJPanel.setSize(250, 50);
		rectanguloJPanel.setSize(300, 150);
		...
		calcularButton.setText("Calcular Rectangulo");
...
// DO NOT EDIT OR ADD ANY CODE HERE!
	...
	private void $$$setupUI$$$() {
		...
		instruccionesTextPane = new JTextPane();
